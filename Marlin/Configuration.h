...
#define MP_SCARA
  ...
  #define SCARA_LINKAGE_1            98 // (mm)
  #define SCARA_LINKAGE_2            98 // (mm)
  ...
  #define SCARA_OFFSET_Y              0 // (mm)
    ...
    #define SCARA_OFFSET_THETA1   18.27 // degrees
    #define SCARA_OFFSET_THETA2   73.55 // degrees

  #endif

  #define THETA_ANGLE_AT_HOME       120 //THETA DEGREE AT LIMIT SWITCH
  #define PSI_ANGLE_AT_HOME         -20 //PSI DEGREE AT LIMIT SWITCH
...
#define STRING_CONFIG_H_AUTHOR "(sL1pKn07, sL1-X-SCARA)"    // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "sL1-X-SCARA"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 26.666667, 80, 1600, 408 }
